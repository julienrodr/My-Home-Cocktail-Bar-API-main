 ...
 * @group Users - Présentation des users
 * @param user.body.required - {"first_name" : "test","last_name" : "test","mail": "test@gmail.com","password": "test","pseudo" : "test}
 ...
 * @group Users - Présentation des users
 * @param {number} id.path - id user
 * @param user.body.required - {"first_name" : "","last_name" : "","mail": "","password": "","pseudo" : ""}
 * @produces application/json application/xml
 * @consumes application/json application/xml
 */
 ...
 * @group Users - Présentation des users
 * @param user.body.required - {"mail": "","password": ""}
